...
(1, 'What is ClassKira?', 'ClassKira is a collection of programs designed to assist schools in administering their executive responsibilities on a day-to-day basis. ClassKira is designed for SAAS (Software as a Service) projects.'),
...
(1, 'system_name', 'ClassKira School Manager'),
(2, 'system_title', 'ClassKira'),
(3, 'system_email', 'contact@classkira.com'),
(4, 'phone', '900500000'),
...
(10, 'language', 'english'),
(11, 'payment_settings', '[]'),
(12, 'footer_text', 'By ClassKira'),
(13, 'footer_link', 'http://classkira.com/'),
(14, 'version', '2.4.2'),
(15, 'fax', '1234567890'),
...
(22, 'smtp_pass', ''),
(28, 'offline', '{\"status\":\"1\"}'),
(29, 'light_logo', 'logo.svg'),
(30, 'dark_logo', 'logo.svg'),
(31, 'favicon', 'logo.svg'),
(32, 'randCallRange', '30'),
(33, 'help_link', 'http://support.classkira.com/'),
...
(38, 'facebook_link', 'https://www.facebook.com/ClassKira'),
(39, 'twitter_link', 'https://twitter.com/classkira'),
(40, 'linkedin_link', 'https://www.linkedin.com/company/classkira'),
(41, 'instagram_link', 'http://www.instagram.com/classkira'),
(42, 'price_subtitle', 'Choose the best subscription plan for your school'),
(43, 'copyright_text', '2024 Academy, All rights reserved'),
(44, 'contact_email', 'contact@classkira.com'),
(45, 'frontend_footer_text', 'ClassKira is a collection of programs designed to assist schools in administering their executive responsibilities on a day-to-day basis. It is designed for SAAS (Software as a Service) projects.'),
(46, 'faq_subtitle', 'Frequently asked questions'),
(49, 'frontend_view', '1'),
(50, 'white_logo', 'logo.svg'),
(51, 'navbar_title', 'ClassKira'),
...
(65, 'front_logo', 'logo.svg'),
(67, 'features_title', 'Features'),
(68, 'features_subtitle', 'Make your application more advanced with ClassKira'),
...
(8, 'english', 'Superadmin | ClassKira', 'Superadmin | ClassKira'),
...
(4182, 'english', 'Payment | ClassKira', 'Payment | ClassKira'),
...
(4210, 'Bangla', 'Superadmin | ClassKira', 'Superadmin | ClassKira'),
...
(4838, 'Bangla', 'Payment | ClassKira', 'Payment | ClassKira'),
...
(10, 'warden', '2023-06-01 11:38:30', '2023-06-01 11:38:30');
...
CREATE TABLE `schools` (
  ...
  `school_info` longtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` int NOT NULL,
...
-- --------------------------------------------------------
-- 5. hostel_room_allocations
-- --------------------------------------------------------
DROP TABLE IF EXISTS `hostel_room_allocations`;
CREATE TABLE `hostel_room_allocations` (
  `id` int(11) NOT NULL,
  `school_id` int(11) DEFAULT NULL,
  `student_id` int(11) DEFAULT NULL,
  `room_id` int(11) DEFAULT NULL,
  `allocated_on` varchar(255) DEFAULT NULL,
  `vacated_on` varchar(255) DEFAULT NULL,
  `status` varchar(255) DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
