...
-- Dumping database structure for classkira


-- Dumping structure for table classkira.addons
...
-- Dumping data for table classkira.addons: ~0 rows (approximately)

-- Dumping structure for table classkira.admit_cards
...
-- Dumping data for table classkira.admit_cards: ~0 rows (approximately)
...
-- Dumping structure for table classkira.appraisals
...
-- Dumping data for table classkira.appraisals: ~0 rows (approximately)

-- Dumping structure for table classkira.appraisal_submits
...
-- Dumping data for table classkira.appraisal_submits: ~0 rows (approximately)

-- Dumping structure for table classkira.books
...
-- Dumping data for table classkira.books: ~0 rows (approximately)

-- Dumping structure for table classkira.book_issues
...
-- Dumping data for table classkira.book_issues: ~0 rows (approximately)

-- Dumping structure for table classkira.chats
...
-- Dumping data for table classkira.chats: ~0 rows (approximately)

-- Dumping structure for table classkira.classes
...
-- Dumping data for table classkira.classes: ~5 rows (approximately)
...
-- Dumping structure for table classkira.class_rooms
...
-- Dumping data for table classkira.class_rooms: ~5 rows (approximately)
...
-- Dumping structure for table classkira.clubs
...
-- Dumping data for table classkira.clubs: ~4 rows (approximately)
...
-- Dumping structure for table classkira.club_members
...
-- Dumping data for table classkira.club_members: ~0 rows (approximately)

-- Dumping structure for table classkira.club_notices
...
-- Dumping data for table classkira.club_notices: ~0 rows (approximately)

-- Dumping structure for table classkira.currency
...
-- Dumping data for table classkira.currency: ~169 rows (approximately)
...
-- Dumping structure for table classkira.daily_attendances
...
-- Dumping data for table classkira.daily_attendances: ~0 rows (approximately)

-- Dumping structure for table classkira.departments
...
-- Dumping data for table classkira.departments: ~4 rows (approximately)
...
-- Dumping structure for table classkira.enrollments
...
-- Dumping data for table classkira.enrollments: ~3 rows (approximately)
...
-- Dumping structure for table classkira.exams
...
-- Dumping data for table classkira.exams: ~0 rows (approximately)

-- Dumping structure for table classkira.exam_categories
...
-- Dumping data for table classkira.exam_categories: ~3 rows (approximately)
...
-- Dumping structure for table classkira.expenses
...
-- Dumping data for table classkira.expenses: ~0 rows (approximately)

-- Dumping structure for table classkira.expense_categories
...
-- Dumping data for table classkira.expense_categories: ~5 rows (approximately)
...
-- Dumping structure for table classkira.failed_jobs
...
-- Dumping data for table classkira.failed_jobs: ~0 rows (approximately)

-- Dumping structure for table classkira.faq
...
-- Dumping data for table classkira.faq: ~4 rows (approximately)
...
-- Dumping structure for table classkira.feedback
...
-- Dumping data for table classkira.feedback: ~0 rows (approximately)

-- Dumping structure for table classkira.frontend_events
...
-- Dumping data for table classkira.frontend_events: ~0 rows (approximately)

-- Dumping structure for table classkira.frontend_features
...
-- Dumping data for table classkira.frontend_features: ~8 rows (approximately)
...
-- Dumping structure for table classkira.global_settings
...
-- Dumping data for table classkira.global_settings: ~64 rows (approximately)
...
-- Dumping structure for table classkira.gradebooks
...
-- Dumping data for table classkira.gradebooks: ~0 rows (approximately)

-- Dumping structure for table classkira.grades
...
-- Dumping data for table classkira.grades: ~7 rows (approximately)
...
-- Dumping structure for table classkira.hostels
...
-- Dumping data for table classkira.hostels: ~2 rows (approximately)
...
-- Dumping structure for table classkira.hostel_applications
...
-- Dumping data for table classkira.hostel_applications: ~0 rows (approximately)

-- Dumping structure for table classkira.hostel_fees
...
-- Dumping data for table classkira.hostel_fees: ~0 rows (approximately)

-- Dumping structure for table classkira.hostel_rooms
...
-- Dumping data for table classkira.hostel_rooms: ~10 rows (approximately)
...
-- Dumping structure for table classkira.hostel_room_allocations
...
-- Dumping data for table classkira.hostel_room_allocations: ~0 rows (approximately)

-- Dumping structure for table classkira.language
...
-- Dumping data for table classkira.language: ~1,366 rows (approximately)
...
-- Dumping structure for table classkira.message_thrades
...
-- Dumping data for table classkira.message_thrades: ~0 rows (approximately)

-- Dumping structure for table classkira.migrations
...
-- Dumping data for table classkira.migrations: ~0 rows (approximately)

-- Dumping structure for table classkira.noticeboard
...
-- Dumping data for table classkira.noticeboard: ~0 rows (approximately)
...
-- Dumping structure for table classkira.packages
...
-- Dumping data for table classkira.packages: ~4 rows (approximately)
...
-- Dumping structure for table classkira.password_resets
...
-- Dumping data for table classkira.password_resets: ~0 rows (approximately)

-- Dumping structure for table classkira.payments
...
-- Dumping data for table classkira.payments: ~0 rows (approximately)

-- Dumping structure for table classkira.payment_gateways
...
-- Dumping data for table classkira.payment_gateways: ~0 rows (approximately)

-- Dumping structure for table classkira.payment_history
...
-- Dumping data for table classkira.payment_history: ~0 rows (approximately)
...
-- Dumping structure for table classkira.payment_methods
...
-- Dumping data for table classkira.payment_methods: ~13 rows (approximately)
...
-- Dumping structure for table classkira.personal_access_tokens
...
-- Dumping data for table classkira.personal_access_tokens: ~0 rows (approximately)

-- Dumping structure for table classkira.roles
...
-- Dumping data for table classkira.roles: ~9 rows (approximately)
...
-- Dumping structure for table classkira.routines
...
-- Dumping data for table classkira.routines: ~0 rows (approximately)

-- Dumping structure for table classkira.schools
...
-- Dumping data for table classkira.schools: ~2 rows (approximately)
...
-- Dumping structure for table classkira.sections
...
-- Dumping data for table classkira.sections: ~10 rows (approximately)
...
-- Dumping structure for table classkira.sessions
...
-- Dumping data for table classkira.sessions: ~0 rows (approximately)
INSERT INTO `sessions` (`id`, `session_title`, `status`, `school_id`, `created_at`, `updated_at`) VALUES
	(1, '2026', 1, NULL, NULL, NULL);

-- Dumping structure for table classkira.student_fee_managers
...
-- Dumping data for table classkira.student_fee_managers: ~0 rows (approximately)

-- Dumping structure for table classkira.subjects
...
-- Dumping data for table classkira.subjects: ~5 rows (approximately)
...
-- Dumping structure for table classkira.subscriptions
...
-- Dumping data for table classkira.subscriptions: ~0 rows (approximately)
...
-- Dumping structure for table classkira.syllabuses
...
-- Dumping data for table classkira.syllabuses: ~0 rows (approximately)

-- Dumping structure for table classkira.teacher_permissions
...
-- Dumping data for table classkira.teacher_permissions: ~0 rows (approximately)

-- Dumping structure for table classkira.users
...
-- Dumping data for table classkira.users: ~9 rows (approximately)
