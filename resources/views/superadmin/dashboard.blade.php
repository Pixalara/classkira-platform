	...
	<div class="col-12">
		<div class="eSection-dashboardItems">
			<div class="row flex-wrap">
				...
				<!-- Upcoming Events -->
				<div class="col-md-7">
                    <div class="card bg-info dashboard-chart-card">
                        <h6 class="ms-4 mt-4 mb-4 text-white">{{ get_phrase('Subscription Payment') }}</h6>
...
<script>
	...
	// Create axes (larger font for readability)
	...
	yAxisRenderer.labels.template.setAll({ fontSize: 13 });
