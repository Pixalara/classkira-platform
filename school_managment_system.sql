...
-- Dumping database structure for school_managmen_system
DROP DATABASE IF EXISTS `school_managmen_system`;
CREATE DATABASE IF NOT EXISTS `school_managmen_system` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `school_managmen_system`;

-- Dumping structure for table school_managmen_system.addons
...
CREATE TABLE IF NOT EXISTS `addons` (
  ...
  `purchase_code` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `unique_identifier` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `status` int NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- Dumping data for table school_managmen_system.addons: ~0 rows (approximately)

-- Dumping structure for table school_managmen_system.admit_cards
...
-- Dumping data for table school_managmen_system.admit_cards: ~0 rows (approximately)
INSERT INTO `admit_cards` (`id`, `template`, `heading`, `title`, `school_id`, `exam_center`, `footer_text`, `left_logo`, `right_logo`, `sign`, `background_image`, `updated_at`, `created_at`) VALUES
	(1, 'default', 'Admit Card', 'Annual Examination', 1, 'Main Hall', 'ClassKira School', NULL, NULL, NULL, NULL, '2026-02-17 20:53:12', '2026-02-17 20:53:12');

-- Dumping structure for table school_managmen_system.appraisals
DROP TABLE IF EXISTS `appraisals`;
CREATE TABLE IF NOT EXISTS `appraisals` (
  `id` int NOT NULL AUTO_INCREMENT,
  `title` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `question` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  `ans_type` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `teacher_id` text COLLATE utf8mb4_general_ci,
...
-- Dumping data for table school_managmen_system.appraisals: ~0 rows (approximately)

-- Dumping structure for table school_managmen_system.appraisal_submits
DROP TABLE IF EXISTS `appraisal_submits`;
CREATE TABLE IF NOT EXISTS `appraisal_submits` (
  `id` int NOT NULL AUTO_INCREMENT,
...
-- Dumping data for table school_managmen_system.appraisal_submits: ~0 rows (approximately)

-- Dumping structure for table school_managmen_system.books
...
-- Dumping data for table school_managmen_system.books: ~0 rows (approximately)

-- Dumping structure for table school_managmen_system.book_issues
...
-- Dumping data for table school_managmen_system.book_issues: ~0 rows (approximately)

-- Dumping structure for table school_managmen_system.chats
...
-- Dumping data for table school_managmen_system.chats: ~0 rows (approximately)

-- Dumping structure for table school_managmen_system.classes
...
-- Dumping data for table school_managmen_system.classes: ~5 rows (approximately)
INSERT INTO `classes` (`id`, `name`, `school_id`, `created_at`, `updated_at`) VALUES
	(1, 'Class 1', 1, '2026-02-17 20:53:11', '2026-02-17 20:53:11'),
	(2, 'Class 2', 1, '2026-02-17 20:53:11', '2026-02-17 20:53:11'),
	(3, 'Class 3', 1, '2026-02-17 20:53:11', '2026-02-17 20:53:11'),
	(4, 'Class 4', 1, '2026-02-17 20:53:11', '2026-02-17 20:53:11'),
	(5, 'Class 5', 1, '2026-02-17 20:53:11', '2026-02-17 20:53:11');

-- Dumping structure for table school_managmen_system.class_rooms
...
-- Dumping data for table school_managmen_system.class_rooms: ~5 rows (approximately)
INSERT INTO `class_rooms` (`id`, `name`, `school_id`, `created_at`, `updated_at`) VALUES
	(1, 'Room 101', 1, '2026-02-17 20:53:11', '2026-02-17 20:53:11'),
	(2, 'Room 102', 1, '2026-02-17 20:53:11', '2026-02-17 20:53:11'),
	(3, 'Room 103', 1, '2026-02-17 20:53:12', '2026-02-17 20:53:12'),
	(4, 'Room 201', 1, '2026-02-17 20:53:12', '2026-02-17 20:53:12'),
	(5, 'Room 202', 1, '2026-02-17 20:53:12', '2026-02-17 20:53:12');

-- Dumping structure for table school_managmen_system.clubs
...
-- Dumping data for table school_managmen_system.clubs: ~4 rows (approximately)
INSERT INTO `clubs` (`id`, `club_name`, `description`, `status`, `created_at`, `updated_at`, `advisor_id`) VALUES
	(1, 'Science Club', 'Science and technology activities', 1, '2026-02-17 20:53:13', '2026-02-17 20:53:13', NULL),
	(2, 'Sports Club', 'Sports and physical activities', 1, '2026-02-17 20:53:13', '2026-02-17 20:53:13', NULL),
	(3, 'Cultural Club', 'Arts and cultural events', 1, '2026-02-17 20:53:13', '2026-02-17 20:53:13', NULL),
	(4, 'Debate Club', 'Debates and public speaking', 1, '2026-02-17 20:53:13', '2026-02-17 20:53:13', NULL);

-- Dumping structure for table school_managmen_system.club_members
...
-- Dumping data for table school_managmen_system.club_members: ~0 rows (approximately)

-- Dumping structure for table school_managmen_system.club_notices
...
-- Dumping data for table school_managmen_system.club_notices: ~0 rows (approximately)

-- Dumping structure for table school_managmen_system.currency
...
-- Dumping data for table school_managmen_system.currency: ~169 rows (approximately)
...
-- Dumping structure for table school_managmen_system.daily_attendances
...
-- Dumping data for table school_managmen_system.daily_attendances: ~0 rows (approximately)

-- Dumping structure for table school_managmen_system.departments
...
-- Dumping data for table school_managmen_system.departments: ~4 rows (approximately)
INSERT INTO `departments` (`id`, `name`, `school_id`, `created_at`, `updated_at`) VALUES
	(1, 'Science', 1, '2026-02-17 20:53:12', '2026-02-17 20:53:12'),
	(2, 'Arts', 1, '2026-02-17 20:53:12', '2026-02-17 20:53:12'),
	(3, 'Commerce', 1, '2026-02-17 20:53:12', '2026-02-17 20:53:12'),
	(4, 'General', 1, '2026-02-17 20:53:12', '2026-02-17 20:53:12');

-- Dumping structure for table school_managmen_system.enrollments
...
-- Dumping data for table school_managmen_system.enrollments: ~3 rows (approximately)
INSERT INTO `enrollments` (`id`, `user_id`, `class_id`, `section_id`, `school_id`, `department_id`, `session_id`, `created_at`, `updated_at`) VALUES
	(1, 7, 1, 1, 1, NULL, 1, '2026-02-17 16:50:52', '2026-02-17 16:50:52'),
	(2, 8, 1, 1, 1, NULL, 1, '2026-02-17 16:50:53', '2026-02-17 16:50:53'),
	(3, 9, 1, 1, 1, NULL, 1, '2026-02-17 16:50:54', '2026-02-17 16:50:54');

-- Dumping structure for table school_managmen_system.exams
...
-- Dumping data for table school_managmen_system.exams: ~0 rows (approximately)

-- Dumping structure for table school_managmen_system.exam_categories
...
-- Dumping data for table school_managmen_system.exam_categories: ~3 rows (approximately)
INSERT INTO `exam_categories` (`id`, `name`, `school_id`, `session_id`, `timestamp`, `created_at`, `updated_at`) VALUES
	(1, 'First Term', 1, 1, 1771339992, '2026-02-17 20:53:12', '2026-02-17 20:53:12'),
	(2, 'Mid Term', 1, 1, 1771339992, '2026-02-17 20:53:12', '2026-02-17 20:53:12'),
	(3, 'Final Exam', 1, 1, 1771339992, '2026-02-17 20:53:12', '2026-02-17 20:53:12');

-- Dumping structure for table school_managmen_system.expenses
...
-- Dumping data for table school_managmen_system.expenses: ~0 rows (approximately)

-- Dumping structure for table school_managmen_system.expense_categories
...
-- Dumping data for table school_managmen_system.expense_categories: ~5 rows (approximately)
INSERT INTO `expense_categories` (`id`, `name`, `school_id`, `session_id`, `created_at`, `updated_at`) VALUES
	(1, 'Salary', 1, 1, '2026-02-17 20:53:12', '2026-02-17 20:53:12'),
	(2, 'Utilities', 1, 1, '2026-02-17 20:53:12', '2026-02-17 20:53:12'),
	(3, 'Supplies', 1, 1, '2026-02-17 20:53:12', '2026-02-17 20:53:12'),
	(4, 'Maintenance', 1, 1, '2026-02-17 20:53:12', '2026-02-17 20:53:12'),
	(5, 'Other', 1, 1, '2026-02-17 20:53:12', '2026-02-17 20:53:12');

-- Dumping structure for table school_managmen_system.failed_jobs
...
-- Dumping data for table school_managmen_system.failed_jobs: ~0 rows (approximately)

-- Dumping structure for table school_managmen_system.faq
...
-- Dumping data for table school_managmen_system.faq: ~4 rows (approximately)
INSERT INTO `faq` (`id`, `title`, `description`) VALUES
	(1, 'What is classKira?', 'classkira  is a collection of programs designed to assist schools in administering their executive responsibilities on a day-to-day basis. classkira is an updated version of classkira ERP (Enterprise Resource Planning). Also, classkira is designed for SAAS (Software as a Service) projects.'),
...
-- Dumping structure for table school_managmen_system.feedback
...
-- Dumping data for table school_managmen_system.feedback: ~0 rows (approximately)

-- Dumping structure for table school_managmen_system.frontend_events
...
-- Dumping data for table school_managmen_system.frontend_events: ~0 rows (approximately)

-- Dumping structure for table school_managmen_system.frontend_features
...
-- Dumping data for table school_managmen_system.frontend_features: ~8 rows (approximately)
INSERT INTO `frontend_features` (`id`, `title`, `description`, `icon`, `created_at`, `updated_at`) VALUES
	(1, 'Student Management', 'Manage students, enrollments, and academic records with ease.', 'fa-solid fa-user-graduate', '2026-02-17 19:59:29', '2026-02-17 19:59:29'),
	(2, 'Attendance Tracking', 'Track daily attendance for students and teachers automatically.', 'fa-solid fa-clipboard-check', '2026-02-17 19:59:29', '2026-02-17 19:59:29'),
	(3, 'Examination System', 'Create exams, admit cards, gradebooks, and generate reports.', 'fa-solid fa-file-lines', '2026-02-17 19:59:29', '2026-02-17 19:59:29'),
	(4, 'Fee Management', 'Manage fees, invoices, and payments with multiple gateways.', 'fa-solid fa-money-bill-wave', '2026-02-17 19:59:29', '2026-02-17 19:59:29'),
	(5, 'Library Management', 'Catalog books, manage issues, and track returns.', 'fa-solid fa-book', '2026-02-17 19:59:29', '2026-02-17 19:59:29'),
	(6, 'Hostel & Transport', 'Manage hostels, rooms, and transport for students.', 'fa-solid fa-building', '2026-02-17 19:59:29', '2026-02-17 19:59:29'),
	(7, 'Reports & Analytics', 'Generate detailed reports and insights for decision making.', 'fa-solid fa-chart-line', '2026-02-17 19:59:29', '2026-02-17 19:59:29'),
	(8, 'Multi-School Support', 'Manage multiple schools from a single superadmin panel.', 'fa-solid fa-school', '2026-02-17 19:59:29', '2026-02-17 19:59:29');

-- Dumping structure for table school_managmen_system.global_settings
...
-- Dumping data for table school_managmen_system.global_settings: ~64 rows (approximately)
INSERT INTO `global_settings` (`id`, `key`, `value`) VALUES
	(1, 'system_name', 'ClassKira'),
	(2, 'system_title', 'ClassKira'),
	(3, 'system_email', 'classkira@domain.com'),
	(4, 'phone', '900500000'),
	...
	(13, 'footer_link', 'https://www.classkira.com/'),
	(14, 'version', '2.4.2'),
	(15, 'fax', '1234567890'),
	(16, 'timezone', 'UTC'),
	(17, 'smtp_protocol', ''),
	...
	(38, 'facebook_link', 'https://www.facebook.com/classkiraApps'),
	...
	(43, 'copyright_text', '2026 Academy, All rights reserved'),
	(44, 'contact_email', 'classkira@domain.com'),
	...
	(68, 'features_subtitle', 'Make your application more advanced with Ekattor 8'),
	(81, 'off_pay_ins_text', 'You can make payments using your mobile banking number.'),
	(82, 'off_pay_ins_file', ''),
	(83, 'recaptcha_site_key', NULL),
	(84, 'recaptcha_secret_key', NULL),
	(85, 'recaptcha_switch_value', 'No');

-- Dumping structure for table school_managmen_system.gradebooks
...
CREATE TABLE IF NOT EXISTS `gradebooks` (
  ...
  `marks` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
...
-- Dumping data for table school_managmen_system.gradebooks: ~0 rows (approximately)

-- Dumping structure for table school_managmen_system.grades
DROP TABLE IF EXISTS `grades`;
CREATE TABLE IF NOT EXISTS `grades` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `grade_point` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
-- Dumping data for table school_managmen_system.grades: ~7 rows (approximately)
INSERT INTO `grades` (`id`, `name`, `grade_point`, `mark_from`, `mark_upto`, `school_id`, `created_at`, `updated_at`) VALUES
	(1, 'A+', '4.00', 80, 100, 1, '2026-02-17 20:53:12', '2026-02-17 20:53:12'),
	(2, 'A', '3.75', 70, 79, 1, '2026-02-17 20:53:12', '2026-02-17 20:53:12'),
	(3, 'A-', '3.50', 60, 69, 1, '2026-02-17 20:53:12', '2026-02-17 20:53:12'),
	(4, 'B', '3.00', 50, 59, 1, '2026-02-17 20:53:12', '2026-02-17 20:53:12'),
	(5, 'C', '2.00', 40, 49, 1, '2026-02-17 20:53:12', '2026-02-17 20:53:12'),
	(6, 'D', '1.00', 33, 39, 1, '2026-02-17 20:53:12', '2026-02-17 20:53:12'),
	(7, 'F', '0.00', 0, 32, 1, '2026-02-17 20:53:12', '2026-02-17 20:53:12');

-- Dumping structure for table school_managmen_system.hostels
...
-- Dumping data for table school_managmen_system.hostels: ~2 rows (approximately)
INSERT INTO `hostels` (`id`, `school_id`, `name`, `type`, `address`, `warden_id`, `created_at`, `updated_at`) VALUES
	(1, 1, 'Boys Hostel', 'boys', 'Campus Block A', NULL, '2026-02-17 20:53:12', '2026-02-17 20:53:12'),
	(2, 1, 'Girls Hostel', 'girls', 'Campus Block B', NULL, '2026-02-17 20:53:12', '2026-02-17 20:53:12');

-- Dumping structure for table school_managmen_system.hostel_applications
...
-- Dumping data for table school_managmen_system.hostel_applications: ~0 rows (approximately)

-- Dumping structure for table school_managmen_system.hostel_fees
...
-- Dumping data for table school_managmen_system.hostel_fees: ~0 rows (approximately)

-- Dumping structure for table school_managmen_system.hostel_rooms
...
-- Dumping data for table school_managmen_system.hostel_rooms: ~10 rows (approximately)
INSERT INTO `hostel_rooms` (`id`, `school_id`, `hostel_id`, `room_no`, `capacity`, `occupied`, `seat_fee`, `description`, `status`, `created_at`, `updated_at`) VALUES
	(1, 1, 1, 'R01', 4, 0, 5000, NULL, 'active', '2026-02-17 20:53:12', '2026-02-17 20:53:12'),
	(2, 1, 1, 'R02', 4, 0, 5000, NULL, 'active', '2026-02-17 20:53:12', '2026-02-17 20:53:12'),
	(3, 1, 1, 'R03', 4, 0, 5000, NULL, 'active', '2026-02-17 20:53:12', '2026-02-17 20:53:12'),
	(4, 1, 1, 'R04', 4, 0, 5000, NULL, 'active', '2026-02-17 20:53:12', '2026-02-17 20:53:12'),
	(5, 1, 1, 'R05', 4, 0, 5000, NULL, 'active', '2026-02-17 20:53:12', '2026-02-17 20:53:12'),
	(6, 1, 2, 'R01', 4, 0, 5000, NULL, 'active', '2026-02-17 20:53:12', '2026-02-17 20:53:12'),
	(7, 1, 2, 'R02', 4, 0, 5000, NULL, 'active', '2026-02-17 20:53:12', '2026-02-17 20:53:12'),
	(8, 1, 2, 'R03', 4, 0, 5000, NULL, 'active', '2026-02-17 20:53:13', '2026-02-17 20:53:13'),
	(9, 1, 2, 'R04', 4, 0, 5000, NULL, 'active', '2026-02-17 20:53:13', '2026-02-17 20:53:13'),
	(10, 1, 2, 'R05', 4, 0, 5000, NULL, 'active', '2026-02-17 20:53:13', '2026-02-17 20:53:13');

-- Dumping structure for table school_managmen_system.hostel_room_allocations
...
CREATE TABLE IF NOT EXISTS `hostel_room_allocations` (
  ...
  `student_id` int DEFAULT NULL,
  `room_id` int DEFAULT NULL,
  `allocated_on` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `vacated_on` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
...
-- Dumping data for table school_managmen_system.hostel_room_allocations: ~0 rows (approximately)

-- Dumping structure for table school_managmen_system.language
...
CREATE TABLE IF NOT EXISTS `language` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5033 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;

-- Dumping data for table school_managmen_system.language: ~1,366 rows (approximately)
INSERT INTO `language` (`id`, `name`, `phrase`, `translated`) VALUES
	...
	(4913, 'english', 'Warden', 'Warden'),
	(4914, 'Bangla', 'Warden', 'Warden'),
	(4915, 'english', 'Club', 'Club'),
	(4916, 'Bangla', 'Club', 'Club'),
	(4917, 'english', 'Appraisal', 'Appraisal'),
	(4918, 'Bangla', 'Appraisal', 'Appraisal'),
	(4919, 'english', 'Appraisal Question', 'Appraisal Question'),
	(4920, 'Bangla', 'Appraisal Question', 'Appraisal Question'),
	(4921, 'english', 'Student Feedback', 'Student Feedback'),
	(4922, 'Bangla', 'Student Feedback', 'Student Feedback'),
	(4923, 'english', 'Hostel', 'Hostel'),
	(4924, 'Bangla', 'Hostel', 'Hostel'),
	(4925, 'english', 'Hostel list', 'Hostel list'),
	(4926, 'Bangla', 'Hostel list', 'Hostel list'),
	(4927, 'english', 'Room list', 'Room list'),
	(4928, 'Bangla', 'Room list', 'Room list'),
	(4929, 'english', 'Allocation list', 'Allocation list'),
	(4930, 'Bangla', 'Allocation list', 'Allocation list'),
	(4931, 'english', 'Applications', 'Applications'),
	(4932, 'Bangla', 'Applications', 'Applications'),
	(4933, 'english', 'Hostel Fees', 'Hostel Fees'),
	(4934, 'Bangla', 'Hostel Fees', 'Hostel Fees'),
	(4935, 'english', 'Offline Payments', 'Offline Payments'),
	(4936, 'Bangla', 'Offline Payments', 'Offline Payments'),
	(4937, 'english', 'Additional information', 'Additional information'),
	(4938, 'Bangla', 'Additional information', 'Additional information'),
	(4939, 'english', 'Enter student information', 'Enter student information'),
	(4940, 'Bangla', 'Enter student information', 'Enter student information'),
	(4941, 'english', 'Navbar Title', 'Navbar Title'),
	(4942, 'Bangla', 'Navbar Title', 'Navbar Title'),
	(4943, 'english', 'System Language', 'System Language'),
	(4944, 'Bangla', 'System Language', 'System Language'),
	(4945, 'english', 'Frontend View', 'Frontend View'),
	(4946, 'Bangla', 'Frontend View', 'Frontend View'),
	(4947, 'english', 'No', 'No'),
	(4948, 'Bangla', 'No', 'No'),
	(4949, 'english', 'Help Link', 'Help Link'),
	(4950, 'Bangla', 'Help Link', 'Help Link'),
	(4951, 'english', 'Youtube Api Key', 'Youtube Api Key'),
	(4952, 'Bangla', 'Youtube Api Key', 'Youtube Api Key'),
	(4953, 'english', 'Vimeo Api Key', 'Vimeo Api Key'),
	(4954, 'Bangla', 'Vimeo Api Key', 'Vimeo Api Key'),
	(4955, 'english', 'Has to be bigger than', 'Has to be bigger than'),
	(4956, 'Bangla', 'Has to be bigger than', 'Has to be bigger than'),
	(4957, 'english', 'Nav Bar Logo', 'Nav Bar Logo'),
	(4958, 'Bangla', 'Nav Bar Logo', 'Nav Bar Logo'),
	(4959, 'english', 'Email Template Settings', 'Email Template Settings'),
	(4960, 'Bangla', 'Email Template Settings', 'Email Template Settings'),
	(4961, 'english', 'Email Title', 'Email Title'),
	(4962, 'Bangla', 'Email Title', 'Email Title'),
	(4963, 'english', 'Email logo', 'Email logo'),
	(4964, 'Bangla', 'Email logo', 'Email logo'),
	(4965, 'english', 'GENERAL SETTINGS', 'GENERAL SETTINGS'),
	(4966, 'Bangla', 'GENERAL SETTINGS', 'GENERAL SETTINGS'),
	(4967, 'english', 'Banner Title', 'Banner Title'),
	(4968, 'Bangla', 'Banner Title', 'Banner Title'),
	(4969, 'english', 'Banner Subtitle', 'Banner Subtitle'),
	(4970, 'Bangla', 'Banner Subtitle', 'Banner Subtitle'),
	(4971, 'english', 'Features Title', 'Features Title'),
	(4972, 'Bangla', 'Features Title', 'Features Title'),
	(4973, 'english', 'Features Subtitle', 'Features Subtitle'),
	(4974, 'Bangla', 'Features Subtitle', 'Features Subtitle'),
	(4975, 'english', 'Price Subtitle', 'Price Subtitle'),
	(4976, 'Bangla', 'Price Subtitle', 'Price Subtitle'),
	(4977, 'english', 'Faq Subtitle', 'Faq Subtitle'),
	(4978, 'Bangla', 'Faq Subtitle', 'Faq Subtitle'),
	(4979, 'english', 'Facebook Link', 'Facebook Link'),
	(4980, 'Bangla', 'Facebook Link', 'Facebook Link'),
	(4981, 'english', 'Twitter Link', 'Twitter Link'),
	(4982, 'Bangla', 'Twitter Link', 'Twitter Link'),
	(4983, 'english', 'Linkedin Link', 'Linkedin Link'),
	(4984, 'Bangla', 'Linkedin Link', 'Linkedin Link'),
	(4985, 'english', 'Instagram Link', 'Instagram Link'),
	(4986, 'Bangla', 'Instagram Link', 'Instagram Link'),
	(4987, 'english', 'Contact Mail', 'Contact Mail'),
	(4988, 'Bangla', 'Contact Mail', 'Contact Mail'),
	(4989, 'english', 'Frontend Footer Text', 'Frontend Footer Text'),
	(4990, 'Bangla', 'Frontend Footer Text', 'Frontend Footer Text'),
	(4991, 'english', 'Copyright Text', 'Copyright Text'),
	(4992, 'Bangla', 'Copyright Text', 'Copyright Text'),
	(4993, 'english', 'Recaptcha', 'Recaptcha'),
	(4994, 'Bangla', 'Recaptcha', 'Recaptcha'),
	(4995, 'english', 'Get Recaptcha Key', 'Get Recaptcha Key'),
	(4996, 'Bangla', 'Get Recaptcha Key', 'Get Recaptcha Key'),
	(4997, 'english', 'Recaptcha Site Key', 'Recaptcha Site Key'),
	(4998, 'Bangla', 'Recaptcha Site Key', 'Recaptcha Site Key'),
	(4999, 'english', 'Recaptcha Secret Key', 'Recaptcha Secret Key'),
	(5000, 'Bangla', 'Recaptcha Secret Key', 'Recaptcha Secret Key'),
	(5001, 'english', 'Frontend Features', 'Frontend Features'),
	(5002, 'Bangla', 'Frontend Features', 'Frontend Features'),
	(5003, 'english', 'Add Frontend Features', 'Add Frontend Features'),
	(5004, 'Bangla', 'Add Frontend Features', 'Add Frontend Features'),
	(5005, 'english', 'Features List Title', 'Features List Title'),
	(5006, 'Bangla', 'Features List Title', 'Features List Title'),
	(5007, 'english', 'Short Description', 'Short Description'),
	(5008, 'Bangla', 'Short Description', 'Short Description'),
	(5009, 'english', 'Features List Image', 'Features List Image'),
	(5010, 'Bangla', 'Features List Image', 'Features List Image'),
	(5011, 'english', 'Features List Icon', 'Features List Icon'),
	(5012, 'Bangla', 'Features List Icon', 'Features List Icon'),
	(5013, 'english', 'Website Logo', 'Website Logo'),
	(5014, 'Bangla', 'Website Logo', 'Website Logo'),
	(5015, 'english', 'Frontend logo', 'Frontend logo'),
	(5016, 'Bangla', 'Frontend logo', 'Frontend logo'),
	(5017, 'english', 'Add question and answer', 'Add question and answer'),
	(5018, 'Bangla', 'Add question and answer', 'Add question and answer'),
	(5019, 'english', 'Faq List', 'Faq List'),
	(5020, 'Bangla', 'Faq List', 'Faq List'),
	(5021, 'english', 'Update question and answer', 'Update question and answer'),
	(5022, 'Bangla', 'Update question and answer', 'Update question and answer'),
	(5023, 'english', 'Offline Payment Instruction', 'Offline Payment Instruction'),
	(5024, 'Bangla', 'Offline Payment Instruction', 'Offline Payment Instruction'),
	(5025, 'english', 'Offline Payment Instruction Image/PDF', 'Offline Payment Instruction Image/PDF'),
	(5026, 'Bangla', 'Offline Payment Instruction Image/PDF', 'Offline Payment Instruction Image/PDF'),
	(5027, 'english', 'Application', 'Application'),
	(5028, 'Bangla', 'Application', 'Application'),
	(5029, 'english', 'Enter your email address to reset your password.', 'Enter your email address to reset your password.'),
	(5030, 'Bangla', 'Enter your email address to reset your password.', 'Enter your email address to reset your password.'),
	(5031, 'english', 'Reset password', 'Reset password'),
	(5032, 'Bangla', 'Reset password', 'Reset password');

-- Dumping structure for table school_managmen_system.message_thrades
...
-- Dumping data for table school_managmen_system.message_thrades: ~0 rows (approximately)

-- Dumping structure for table school_managmen_system.migrations
...
-- Dumping data for table school_managmen_system.migrations: ~0 rows (approximately)

-- Dumping structure for table school_managmen_system.noticeboard
DROP TABLE IF EXISTS `noticeboard`;
CREATE TABLE IF NOT EXISTS `noticeboard` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `notice_title` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
-- Dumping data for table school_managmen_system.noticeboard: ~0 rows (approximately)
INSERT INTO `noticeboard` (`id`, `notice_title`, `notice`, `start_date`, `start_time`, `end_date`, `end_time`, `status`, `show_on_website`, `image`, `school_id`, `session_id`, `created_at`, `updated_at`) VALUES
	(1, 'Welcome Notice', 'Welcome to the new academic session. Please check the noticeboard regularly for updates.', '2026-02-17', '09:00', '2026-03-17', '17:00', 1, 1, NULL, 1, 1, '2026-02-17 20:53:13', '2026-02-17 20:53:13');

-- Dumping structure for table school_managmen_system.packages
...
CREATE TABLE IF NOT EXISTS `packages` (
  ...
  `studentLimit` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
-- Dumping data for table school_managmen_system.packages: ~4 rows (approximately)
INSERT INTO `packages` (`id`, `name`, `price`, `package_type`, `interval`, `days`, `studentLimit`, `features`, `status`, `description`, `created_at`, `updated_at`) VALUES
	(1, 'Starter', '29', 'school', 'Monthly', 30, '50', '["Student Management","Teacher Management","Attendance","Examinations","Reports"]', 1, 'Best for small schools getting started.', '2026-02-17 19:59:29', '2026-02-17 19:59:29'),
	(2, 'Professional', '79', 'school', 'Monthly', 30, '200', '["Everything in Starter","Library Management","Hostel Management","Accounting","Online Payments"]', 1, 'For growing schools with more needs.', '2026-02-17 19:59:29', '2026-02-17 19:59:29'),
	(3, 'Enterprise', '199', 'school', 'Monthly', 30, 'Unlimited', '["Everything in Professional","Unlimited Students","Priority Support","Custom Reports","API Access"]', 1, 'For large institutions.', '2026-02-17 19:59:29', '2026-02-17 19:59:29'),
	(4, 'Yearly Professional', '790', 'school', 'Yearly', 365, '200', '["Everything in Professional","2 months FREE","Best value"]', 1, 'Save 17% with yearly billing.', '2026-02-17 19:59:29', '2026-02-17 19:59:29');

-- Dumping structure for table school_managmen_system.password_resets
...
-- Dumping data for table school_managmen_system.password_resets: ~0 rows (approximately)

-- Dumping structure for table school_managmen_system.payments
DROP TABLE IF EXISTS `payments`;
CREATE TABLE IF NOT EXISTS `payments` (
  `id` int NOT NULL AUTO_INCREMENT,
  `expense_type` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `expense_id` int NOT NULL,
  `user_id` int NOT NULL,
  `payment_method` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `amount` decimal(10,2) NOT NULL,
  `status` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `transaction_keys` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
-- Dumping data for table school_managmen_system.payments: ~0 rows (approximately)

-- Dumping structure for table school_managmen_system.payment_gateways
DROP TABLE IF EXISTS `payment_gateways`;
CREATE TABLE IF NOT EXISTS `payment_gateways` (
  `id` int NOT NULL AUTO_INCREMENT,
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `status` int DEFAULT NULL,
  `configuration` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `created_at` int NOT NULL,
  `updated_at` int NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- Dumping data for table school_managmen_system.payment_gateways: ~0 rows (approximately)

-- Dumping structure for table school_managmen_system.payment_history
...
CREATE TABLE IF NOT EXISTS `payment_history` (
  ...
  `school_id` int DEFAULT NULL,
  `transaction_keys` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  `document_image` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `paid_by` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
...
-- Dumping data for table school_managmen_system.payment_history: ~0 rows (approximately)
INSERT INTO `payment_history` (`id`, `payment_type`, `user_id`, `course_id`, `package_id`, `amount`, `school_id`, `transaction_keys`, `document_image`, `paid_by`, `status`, `timestamp`, `created_at`, `updated_at`) VALUES
	(1, 'subscription', 2, NULL, 1, 29, 1, '[]', '3.jpg', 'offline', 'approve', 1771346143, '2026-02-17 17:05:43', '2026-02-17 17:28:50');

-- Dumping structure for table school_managmen_system.payment_methods
DROP TABLE IF EXISTS `payment_methods`;
CREATE TABLE IF NOT EXISTS `payment_methods` (
  `id` int NOT NULL AUTO_INCREMENT,
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `payment_keys` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `image` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `status` int NOT NULL DEFAULT '0' COMMENT '0=inactive , 1=active',
  `mode` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'test' COMMENT 'test / live',
  `created_at` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `updated_at` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `school_id` int DEFAULT NULL,
  PRIMARY KEY (`id`)
...
-- Dumping data for table school_managmen_system.payment_methods: ~13 rows (approximately)
...
-- Dumping structure for table school_managmen_system.personal_access_tokens
...
-- Dumping data for table school_managmen_system.personal_access_tokens: ~0 rows (approximately)

-- Dumping structure for table school_managmen_system.roles
...
-- Dumping data for table school_managmen_system.roles: ~9 rows (approximately)
INSERT INTO `roles` (`role_id`, `name`, `created_at`, `updated_at`) VALUES
	...
	(10, 'warden', '2026-02-17 19:59:29', '2026-02-17 19:59:29');

-- Dumping structure for table school_managmen_system.routines
...
-- Dumping data for table school_managmen_system.routines: ~0 rows (approximately)

-- Dumping structure for table school_managmen_system.schools
...
CREATE TABLE IF NOT EXISTS `schools` (
  ...
  `school_info` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `status` int NOT NULL,
  `running_session` int DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `school_currency` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `email_title` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `email_details` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `warning_text` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `socialLink1` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `socialLink2` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `socialLink3` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `email_logo` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `socialLogo1` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `socialLogo2` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `socialLogo3` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `off_pay_ins_text` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `off_pay_ins_file` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table school_managmen_system.schools: ~2 rows (approximately)
INSERT INTO `schools` (`id`, `title`, `email`, `phone`, `address`, `school_info`, `status`, `running_session`, `created_at`, `updated_at`, `school_currency`, `currency_position`, `school_logo`, `email_title`, `email_details`, `warning_text`, `socialLink1`, `socialLink2`, `socialLink3`, `email_logo`, `socialLogo1`, `socialLogo2`, `socialLogo3`, `off_pay_ins_text`, `off_pay_ins_file`) VALUES
	(1, 'Demo School', 'school@classkira.com', '+1234567890', '123 Education Street, City', 'A demonstration school for ClassKira.', 1, 1, '2026-02-17 19:59:29', '2026-02-17 17:28:50', 'USD', 'left-space', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
	(2, 'Sample Academy', 'academy@classkira.com', '+1234567891', '456 Learning Avenue, Town', 'Sample academy for testing.', 1, 1, '2026-02-17 19:59:29', '2026-02-17 19:59:29', 'USD', 'left-space', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);

-- Dumping structure for table school_managmen_system.sections
...
-- Dumping data for table school_managmen_system.sections: ~10 rows (approximately)
INSERT INTO `sections` (`id`, `name`, `class_id`, `created_at`, `updated_at`) VALUES
	(1, 'Section A', 1, '2026-02-17 20:53:11', '2026-02-17 20:53:11'),
	(2, 'Section B', 1, '2026-02-17 20:53:11', '2026-02-17 20:53:11'),
	(3, 'Section A', 2, '2026-02-17 20:53:11', '2026-02-17 20:53:11'),
	(4, 'Section B', 2, '2026-02-17 20:53:11', '2026-02-17 20:53:11'),
	(5, 'Section A', 3, '2026-02-17 20:53:11', '2026-02-17 20:53:11'),
	(6, 'Section B', 3, '2026-02-17 20:53:11', '2026-02-17 20:53:11'),
	(7, 'Section A', 4, '2026-02-17 20:53:11', '2026-02-17 20:53:11'),
	(8, 'Section B', 4, '2026-02-17 20:53:11', '2026-02-17 20:53:11'),
	(9, 'Section A', 5, '2026-02-17 20:53:11', '2026-02-17 20:53:11'),
	(10, 'Section B', 5, '2026-02-17 20:53:11', '2026-02-17 20:53:11');

-- Dumping structure for table school_managmen_system.sessions
DROP TABLE IF EXISTS `sessions`;
CREATE TABLE IF NOT EXISTS `sessions` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `session_title` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` int NOT NULL,
  `school_id` int DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
-- Dumping data for table school_managmen_system.sessions: ~0 rows (approximately)
INSERT INTO `sessions` (`id`, `session_title`, `status`, `school_id`, `created_at`, `updated_at`) VALUES
	(1, '2026', 1, NULL, NULL, NULL);

-- Dumping structure for table school_managmen_system.student_fee_managers
DROP TABLE IF EXISTS `student_fee_managers`;
CREATE TABLE IF NOT EXISTS `student_fee_managers` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `title` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `document_image` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table school_managmen_system.student_fee_managers: ~0 rows (approximately)

-- Dumping structure for table school_managmen_system.subjects
...
-- Dumping data for table school_managmen_system.subjects: ~5 rows (approximately)
INSERT INTO `subjects` (`id`, `name`, `class_id`, `school_id`, `session_id`, `created_at`, `updated_at`) VALUES
	(1, 'Mathematics', 1, 1, 1, '2026-02-17 20:53:12', '2026-02-17 20:53:12'),
	(2, 'English', 1, 1, 1, '2026-02-17 20:53:12', '2026-02-17 20:53:12'),
	(3, 'Science', 1, 1, 1, '2026-02-17 20:53:12', '2026-02-17 20:53:12'),
	(4, 'Social Studies', 1, 1, 1, '2026-02-17 20:53:12', '2026-02-17 20:53:12'),
	(5, 'Bengali', 1, 1, 1, '2026-02-17 20:53:12', '2026-02-17 20:53:12');

-- Dumping structure for table school_managmen_system.subscriptions
...
CREATE TABLE IF NOT EXISTS `subscriptions` (
  ...
  `transaction_keys` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
-- Dumping data for table school_managmen_system.subscriptions: ~0 rows (approximately)
INSERT INTO `subscriptions` (`id`, `package_id`, `school_id`, `paid_amount`, `payment_method`, `transaction_keys`, `expire_date`, `studentLimit`, `date_added`, `active`, `status`, `created_at`, `updated_at`) VALUES
	(1, 1, 1, 29.00, 'Offline', '{"document_file":"3.jpg"}', 1849107529, '50', 1771264800, 1, 1, '2026-02-17 17:28:50', '2026-02-17 17:28:50');

-- Dumping structure for table school_managmen_system.syllabuses
...
-- Dumping data for table school_managmen_system.syllabuses: ~0 rows (approximately)

-- Dumping structure for table school_managmen_system.teacher_permissions
...
-- Dumping data for table school_managmen_system.teacher_permissions: ~0 rows (approximately)

-- Dumping structure for table school_managmen_system.users
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `user_information` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `student_info` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `documents` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `status` int DEFAULT NULL,
  `department_id` int DEFAULT NULL,
  `designation` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `language` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `menu_permission` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
...
-- Dumping data for table school_managmen_system.users: ~9 rows (approximately)
INSERT INTO `users` (`id`, `name`, `email`, `email_verified_at`, `role_id`, `school_role`, `parent_id`, `school_id`, `password`, `code`, `user_information`, `student_info`, `documents`, `status`, `department_id`, `designation`, `language`, `menu_permission`, `account_status`, `remember_token`, `created_at`, `updated_at`) VALUES
	(1, 'Super Admin', 'superadmin@gmail.com', NULL, 1, NULL, NULL, NULL, '$2y$10$w1Lc71sG5A7YABtYj6icleUdLy1ibEl6pou1tluwMmaPst5uzv2pi', NULL, '{"gender":"Male","blood_group":"a+","birthday":1771328969,"phone":"9524003844","address":"Chennai","photo":"user.png"}', NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, '2026-02-17 12:19:30', '2026-02-17 12:19:30'),
	(2, 'School Admin', 'admin@demoschool.com', NULL, 2, NULL, NULL, 1, '$2y$10$3rBXMbdqOjqNWJXUjFFUju.fHwIzQYtvlwlSxKYtKUSTOtYpk6EG6', NULL, '{"gender":"Male","blood_group":"a+","birthday":1771339989,"phone":"+1234567890","address":"123 Education Street","photo":"user.png"}', NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, '2026-02-17 20:53:10', '2026-02-17 20:53:10'),
	(3, 'John Smith', 'teacher@demoschool.com', NULL, 3, NULL, NULL, 1, '$2y$10$1qR5.Y9Tv8OAiA7ngsEhFuc2rJFVLT3oeZlf/AK5TVBbiDtqDEeye', NULL, '{"gender":"Male","blood_group":"a+","birthday":1771345250,"phone":"+1234567890","address":"123 Education Street","photo":"user.png"}', NULL, NULL, 1, 1, 'Teacher', NULL, NULL, NULL, NULL, '2026-02-17 16:50:50', '2026-02-17 16:50:50'),
	(4, 'Jane Doe', 'jane.teacher@demoschool.com', NULL, 3, NULL, NULL, 1, '$2y$10$Eof5roWknybFCgWWnPANLes4XEpMmcxO8GPeWCoFCmwF/i1PRq3iG', NULL, '{"gender":"Male","blood_group":"a+","birthday":1771345250,"phone":"+1234567890","address":"123 Education Street","photo":"user.png"}', NULL, NULL, 1, 1, 'Teacher', NULL, NULL, NULL, NULL, '2026-02-17 16:50:51', '2026-02-17 16:50:51'),
	(5, 'Robert Parent', 'parent@demoschool.com', NULL, 6, NULL, NULL, 1, '$2y$10$GeT/qM6vnks6UufrCgSOa.AVEtFJyI6Ltz9FL/wHCYtpFnKUcVw0K', NULL, '{"gender":"Male","blood_group":"a+","birthday":1771345250,"phone":"+1234567890","address":"123 Education Street","photo":"user.png"}', NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, '2026-02-17 16:50:51', '2026-02-17 16:50:51'),
	(6, 'Mary Williams', 'mary.parent@demoschool.com', NULL, 6, NULL, NULL, 1, '$2y$10$AonotFs5yJ/p6l9Ohs6GwuvYdydT7dM8iD5DoTBsrdX2VxvSMUVB6', NULL, '{"gender":"Female","blood_group":"a+","birthday":1771345250,"phone":"+1234567890","address":"123 Education Street","photo":"user.png"}', NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, '2026-02-17 16:50:52', '2026-02-17 16:50:52'),
	(7, 'Alex Student', 'student@demoschool.com', NULL, 7, NULL, 5, 1, '$2y$10$R4WyKHmiLpdKRv2xaBik3OI9z9uoTvyBWF2.Fozyd7SFzf0CS8U8K', NULL, '{"gender":"Male","blood_group":"a+","birthday":1771345250,"phone":"+1234567890","address":"123 Education Street","photo":"user.png"}', '{"blood_group":"a+","birthday":1771345252}', NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, '2026-02-17 16:50:52', '2026-02-17 16:50:52'),
	(8, 'Emma Student', 'emma.student@demoschool.com', NULL, 7, NULL, 5, 1, '$2y$10$eaV0BxhvHjlVTYtta5VDVe2gemWA9X/qVDq2jhxjt8M0BMcxkpgdq', NULL, '{"gender":"Male","blood_group":"a+","birthday":1771345250,"phone":"+1234567890","address":"123 Education Street","photo":"user.png"}', '{"blood_group":"a+","birthday":1771345252}', NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, '2026-02-17 16:50:53', '2026-02-17 16:50:53'),
	(9, 'Jack Student', 'jack.student@demoschool.com', NULL, 7, NULL, 6, 1, '$2y$10$oEP7mW/CtVD9iyI3O9I6retYmMm5gw8QFtg76pUuRUMW/P3t74pOS', NULL, '{"gender":"Male","blood_group":"a+","birthday":1771345250,"phone":"+1234567890","address":"123 Education Street","photo":"user.png"}', '{"blood_group":"a+","birthday":1771345252}', NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, '2026-02-17 16:50:54', '2026-02-17 16:50:54');
